...
public class NameSamplerTest {
    ...
    public void testName() {
        ...
        for (String s : expected) {
            assertEquals("regression 1", s, ns.doSample().asText());
        }
        ...
        for (String s : expected) {
            assertEquals("regression 2", s, ns.doSample().asText());
        }
        ...
        for (String s : expected) {
            assertEquals("regression 3", s, ns.doSample().asText());
        }
        ...
        for (String s : expected) {
            assertEquals("regression 4", s, ns.doSample().asText());
        }
    }
}
